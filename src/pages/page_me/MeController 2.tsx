...
//images
const image_of_me_headshot = require('../../assets/images/IMG_6700.jpeg');
const github_logo = require('../../assets/images/github_logo.jpeg');
const twitter_logo = require('../../assets/images/twitter_logo.jpeg');
const linkedin_logo = require('../../assets/images/linkedin_logo.jpeg');

//content that is imported from a json
const data_asset = require('../../assets/Me-Data/data.json');
            ...
            <div className={"me-page-flexbox-wrapper"}>
                ...
                <div className={"me-content-column"}>
                    ...
                    <div id={"courses"}>
                        <h2>Courses</h2>
                        <div>
                            {text_data.courses_section.map((course_data: string[]) => {
                                return (
                                    <div>
                                        <h3>{course_data[0]}</h3>
                                        <p>{course_data[1]}</p>
                    ...
                    <div id={"goals"}>
                        <h2>Goals</h2>
                        <div>
                            {text_data.goals_section.map((goal_data: string[]) => {
                                return (
                                    <div>
                                        <h3>{goal_data[0]}</h3>
                                        <p>{goal_data[1]}</p>
